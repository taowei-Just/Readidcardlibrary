...
public class SerialSdtapi  extends  Api{

    Common common = new Common();


    public SerialSdtapi(Context instance) throws Exception {
        this.usbapi = new SerialSdtusbapi(instance);
    }

    public SerialSdtapi() throws Exception {
        this.usbapi = new SerialSdtusbapi();
    }
